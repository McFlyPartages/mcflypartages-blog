...
{{< alert "Pour que le tout reste joli, il existe des boitier comme Argon One M.2 qui permettent d'intégrer le disque dans un boitier" info >}}
...
La troisieme vous permet de partager anonymement certaines données, pour aider Home Assistant a améliorer le systeme.

La quatrieme concerne les matériels détectés automatiquement par Home Assistant chez vous.
...
## Activer les parametres avancés.
Le mode avancé vous permet d'avoir plus de controle sur votre serveur.
